...
def mock_llm_service() -> Generator[MagicMock, None, None]:
    ...
    with patch('app.services.llm.LLMService') as mock:
        ...
        mock.return_value.get_completion.return_value = (
            "This is a mock LLM response"
        )
        # Mock available models
        mock.return_value.available_providers = ["mock_provider"]
        mock.return_value.current_provider = "mock_provider"
        mock.return_value.current_model = "mock_model"
        yield mock
